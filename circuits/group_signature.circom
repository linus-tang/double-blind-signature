...
include "https://github.com/linus-tang/double-blind-signature/blob/main/fixed_long_operations.circom";
...
template GroupSignature(n, k, sizeGroup){
    signal input message_hash[k];        // Hash of the message to be signed
    signal input signer_sk[k];          // Signer's private key
